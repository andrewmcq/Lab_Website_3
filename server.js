...
app.get('/team_stats', function(rec, res) {
...
app.get('/player_info/select_player', function(req, res) {
	...
	var query2 = 'SELECT * FROM football_players WHERE '+ playerid +' = id';
	var query3 = 'SELECT COUNT(football_games.visitor_name) FROM football_games INNER JOIN football_players ON '+ playerid+'=ANY(football_games.players) WHERE ID = '+ playerid +';';
	db.task('get-everything', task => {
	    return task.batch([
	        task.any(query1),
	        task.any(query2),
